...
define.classMethod('open', {callback: true, promise:false});
...
define.classMethod('createCollection', {callback: true, promise:false});
 ...
 * @deprecated MongoDB plans to end eval support in the near future
 * @return {null}
 */
...
define.classMethod('eval', {callback: true, promise:false});
...
define.classMethod('renameCollection', {callback: true, promise:false});
...
define.classMethod('dropCollection', {callback: true, promise:false});
...
define.classMethod('dropDatabase', {callback: true, promise:false});
...
define.classMethod('collections', {callback: true, promise:false});
...
define.classMethod('executeDbAdminCommand', {callback: true, promise:false});
...
define.classMethod('addUser', {callback: true, promise:false});
...
define.classMethod('removeUser', {callback: true, promise:false});
...
define.classMethod('authenticate', {callback: true, promise:false});
