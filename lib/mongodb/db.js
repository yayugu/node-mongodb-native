...
var QueryCommand = require('./commands/query_command').QueryCommand
  ...
  , utils = require('./utils')
  , ServerCapabilities = require('./connection/server_capabilities').ServerCapabilities
 ...
 *  - **promoteLongs** {Boolean, default:false}, when deserializing a Long will fit it into a Number if it's smaller than 53 bits
 * 
 * Deprecated Options 
...
Db.prototype.command = function(selector, options, callback) {
  ...
  // If we have a passed in connection
