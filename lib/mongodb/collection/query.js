...
var find = function find () {
  ...
  // Create the cursor
  var cursor = new Cursor(this.db, this, selector, fields, o);
  // Create precursor
  var preCursor = new PreCursor(this, _options);
  // callback for backward compatibility
  if(callback) return callback(null, preCursor.find(selector));
  return preCursor.find(selector);
