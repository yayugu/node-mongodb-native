...
var AggregationCursor = function(collection, serverCapabilities) {	
	...
	this.get = function(callback) {
	  ...
	  var connection = collection.db.serverConfig.checkoutReader(_options.readPreference);
		// Fallback to fake cursor
		...
		commandCursor.get({connection: connection}, callback);
	}
